...
def main():
    ...
    def addprargraph(examples):
        examples["context"] = data_context[examples["relevant"]]
        examples["answer"]["answer_start"] = examples["answer"]["start"]
        del examples["answer"]["start"]
        return examples
    raw_datasets = raw_datasets.map(addprargraph)
    ...
    def post_processing_function(examples, features, predictions, stage="eval"):
        ...
        for ref in references:
            if isinstance(ref['answers'], dict):
                ...
                ref['answers']['answer_start'] = [ref['answers']['answer_start']]
    ...
    if args.resume_from_checkpoint:
        ...
        if "epoch" in training_difference:
            ...
            resume_step = int(match.group(1)) * args.gradient_accumulation_steps
